...
import 'package:flutter_translator_app/src/presentation/pages/favourite_page/favourite_page_controller.dart';
                ...
                child: GestureDetector(
                  ...
                  child: ListTile(
                    ...
                    trailing: AnimatedOnTapButton(
                      onTap: () => favouritePageController.deleteFavourite(element),
                      child: Icon(
                        Icons.star,
                ...
                RichText(
                  ...
                  text: TextSpan(
                      children: [
                        ...
                        TextSpan(
                            text: 'Tap the star icon to save translations you use most',
                            style: TextStyle(
                                fontSize: 40.sp,
                                fontWeight: FontWeight.w500,
                                color: appColors.colorText2
