...
class Definitions extends StatelessWidget {
  ...
  const Definitions({super.key, required this.translateProvider});
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            (definitions.definitions!.indexOf(subDef) + 1)
                                .toString(),
                            style: TextStyle(
                                color: appColors.colorText1,
                                fontSize: 20.sp,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (translateProvider
                                      .translate!.source!.synonyms !=
                                  null)
                                ...translateProvider
                                    .translate!.source!.synonyms!
                                    .map((synonym) {
                                  List<Synonym> listSynonym = [];
                                  int synIndex = translateProvider
                                      .translate!.source!.synonyms!
                                      .indexOf(synonym);
                                  if (translateProvider
                                      .translate!
                                      .source!
                                      .synonyms![translateProvider
                                          .translate!.source!.synonyms!
                                          .indexOf(synonym)]
                                      .isNotEmpty) {
                                    for (int i = 0;
